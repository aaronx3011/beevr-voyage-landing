            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
                <div className="flex justify-between items-center h-24">
                    ...
                    <div className="hidden md:flex items-center gap-6 text-[10px] uppercase font-bold tracking-[0.2em] text-gray-400">
                        ...
                        <a href="mailto:admin@beevr.voyage">
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-8 text-[12px] uppercase font-bold tracking-[0.2em] text-gray-400">
                            ...
                            <a href="mailto:admin@beevr.voyage" className="w-full">
                    ...
                    <div className="space-y-8">
                        ...
                        <ul className="space-y-4 text-sm text-gray-400 font-light">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:admin@beevr.voyage" className="hover:text-amber-400 transition-colors lowercase tracking-wider font-medium">admin@beevr.voyage</a>
                            </li>
                        </ul>
                    </div>
